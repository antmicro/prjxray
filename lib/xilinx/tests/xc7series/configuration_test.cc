...
TEST(ConfigurationTest, CreatePartialConfigurationPackage) {
	...
	// <0x800000> plus <0x800180>. We create address gaps which should be filled
	// with zero frames and the final configuration package should have two
	// data packets separated with two different FAR addresses: one for
	// CLB_IO_CLK=<0x100> and second for BRAM=<0x800000>
